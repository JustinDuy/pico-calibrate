...
public:
    ...
    {
        CalibrationDialog->setWindowTitle(QApplication::translate("CalibrationDialog", "Calibration", 0));
        file_label->setText(QApplication::translate("CalibrationDialog", "Calibration file", 0));
        load_button->setText(QApplication::translate("CalibrationDialog", "Load...", 0));
        save_button->setText(QApplication::translate("CalibrationDialog", "Save...", 0));
        close_button->setText(QApplication::translate("CalibrationDialog", "Close", 0));
    } // retranslateUi
