...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Camera-Projector Calibration", 0));
        label->setText(QString());
        title_label->setText(QApplication::translate("AboutDialog", "3D Scanning Software", 0));
        course_label->setText(QApplication::translate("AboutDialog", "Simple, Accurate, and Robust Projector-Camera Calibration", 0));
        label_author->setText(QApplication::translate("AboutDialog", "Daniel Moreno and Gabriel Taubin", 0));
        qt_version_title_label->setText(QApplication::translate("AboutDialog", "Qt Version:", 0));
        qt_version_label->setText(QApplication::translate("AboutDialog", "qt ver", 0));
        opencv_title_label->setText(QApplication::translate("AboutDialog", "OpenCV Version:", 0));
        opencv_version_label->setText(QApplication::translate("AboutDialog", "opencv ver", 0));
        built_date_title_label->setText(QApplication::translate("AboutDialog", "Built on:", 0));
        built_date_label->setText(QApplication::translate("AboutDialog", "build date time", 0));
        url_title_label->setText(QApplication::translate("AboutDialog", "URL:", 0));
        url_label->setText(QApplication::translate("AboutDialog", "<html><head/><body><p><a href=\"http://mesh.brown.edu/scanning/\"><span style=\" text-decoration: underline; color:#0000ff;\">http://mesh.brown.edu/scanning/</span></a></p></body></html>", 0));
        author_label->setText(QApplication::translate("AboutDialog", "(c) 2012-2015 Daniel Moreno and Gabriel Taubin", 0));
        close_button->setText(QApplication::translate("AboutDialog", "Close", 0));
    } // retranslateUi
