...
public:
    ...
    {
        ProcessingDialog->setWindowTitle(QApplication::translate("ProcessingDialog", "Progress", 0));
        progress_label->setText(QApplication::translate("ProcessingDialog", "Progress", 0));
        current_message_label->setText(QApplication::translate("ProcessingDialog", "message", 0));
        close_cancel_button->setText(QApplication::translate("ProcessingDialog", "Close", 0));
    } // retranslateUi
