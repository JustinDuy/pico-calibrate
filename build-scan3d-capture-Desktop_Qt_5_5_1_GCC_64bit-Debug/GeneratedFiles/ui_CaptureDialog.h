...
public:
    ...
    {
        CaptureDialog->setWindowTitle(QApplication::translate("CaptureDialog", "Capture", 0));
        projector_group->setTitle(QApplication::translate("CaptureDialog", "Projector", 0));
        screen_label->setText(QApplication::translate("CaptureDialog", "Screen:", 0));
        projector_patterns_label->setText(QApplication::translate("CaptureDialog", "Patterns:", 0));
        continuous_check->setText(QApplication::translate("CaptureDialog", "Continuous", 0));
        test_check->setText(QApplication::translate("CaptureDialog", "Preview", 0));
        test_prev_button->setText(QApplication::translate("CaptureDialog", "Prev", 0));
        test_next_button->setText(QApplication::translate("CaptureDialog", "Next", 0));
        camera_group->setTitle(QApplication::translate("CaptureDialog", "Camera", 0));
        camera_label->setText(QApplication::translate("CaptureDialog", "Camera:", 0));
        camera_resolution_label->setText(QApplication::translate("CaptureDialog", "image size", 0));
#ifndef QT_NO_TOOLTIP
        camera_exposure_label->setToolTip(QApplication::translate("CaptureDialog", "<html><head/><body><p>Adjust to be at least the value of the camera (or larger). This control does not change the actual camera settings.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
        camera_exposure_label->setText(QApplication::translate("CaptureDialog", "Wait/Exposure time[ms]:", 0));
        other_group->setTitle(QApplication::translate("CaptureDialog", "Other", 0));
        rotation_label->setText(QApplication::translate("CaptureDialog", "Rotation:", 0));
        rot_000_radio->setText(QApplication::translate("CaptureDialog", "0", 0));
        rot_090_radio->setText(QApplication::translate("CaptureDialog", "90", 0));
        rot_180_radio->setText(QApplication::translate("CaptureDialog", "180", 0));
        rot_270_radio->setText(QApplication::translate("CaptureDialog", "270", 0));
        output_dir_label->setText(QApplication::translate("CaptureDialog", "Output folder:", 0));
        output_dir_button->setText(QApplication::translate("CaptureDialog", "...", 0));
        current_message_label->setText(QApplication::translate("CaptureDialog", "message", 0));
        progress_label->setText(QApplication::translate("CaptureDialog", "Progress", 0));
        capture_button->setText(QApplication::translate("CaptureDialog", "Capture", 0));
        close_cancel_button->setText(QApplication::translate("CaptureDialog", "Close", 0));
    } // retranslateUi
